...
base_model = tf.keras.applications.DenseNet121(
    weights = 'imagenet', # use pretrained for full datasets, 'None' for limited data settings
    include_top = False,  
    input_shape = (128, 128, 3) # 128x128 for all datasets except for ALL-IDB2 which is preprocessed to 224x224
)
